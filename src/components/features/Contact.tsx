...
export default function Contact() {
  ...
  return (
    <section
      id="Contact"
      className="min-h-screen bg-[#fafafa] flex items-center justify-center lg:px-3 relative overflow-hidden bg-white"
    >
            ...
            <div className="w-2/5">
              ...
              >
                ...
                <button
                  ...
                  className="bg-[#131313] text-white font-semibold py-3 mt-5 rounded-full hover:bg-[#000000] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
